...
public class SpecificExceptionHandler {
    ...
    public CustomException handleNullPointerException(NullPointerException ex) {
      ...
      CustomException exception = new CustomException(HttpStatus.INTERNAL_SERVER_ERROR, ex, "No se pudo realizar el llamado porque el metodo devuelve null.");
    ...
    public CustomException handleNoHandlerFoundException(HttpServletRequest request, Exception ex) {
        ...
        CustomException exception = new CustomException(HttpStatus.NOT_FOUND);
    ...
    public CustomException handleBadRequest(MismatchedInputException e) {
        ...
        CustomException exception = new CustomException(HttpStatus.BAD_REQUEST, e, fieldError);
    ...
    public CustomException handleDataIntegrityViolationException(DataIntegrityViolationException ex) {
        // Log the exception and return a custom error page
        CustomException exception = new CustomException(HttpStatus.CONFLICT, ex, "Se ha producido una violación de la integridad de los datos");
    ...
    public CustomException handleHttpRequestMethodNotSupportedException(HttpServletRequest request, HttpRequestMethodNotSupportedException ex) {
        // Log the exception and return a custom error page
        CustomException exception = new CustomException(HttpStatus.METHOD_NOT_ALLOWED, ex, "El método HTTP solicitado no está soportado por el controlador");
    ...
    public CustomException handleMaxUploadSizeExceededException(HttpServletRequest request, MaxUploadSizeExceededException ex) {
        // Log the exception and return a custom error page
        CustomException exception = new CustomException(HttpStatus.PAYLOAD_TOO_LARGE, ex, "El archivo que intenta subir supera el tamaño máximo permitido");
